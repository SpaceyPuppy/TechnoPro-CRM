    ...
    routes: [
      ...
      ShellRoute(
        ...
        routes: [
          ...
          GoRoute(path: '/procurement', builder: (_, __) => const PurchaseOrdersListScreen(), routes: [GoRoute(path: 'suppliers', builder: (_, __) => const SuppliersScreen()), GoRoute(path: 'new', builder: (_, __) => const PurchaseOrderFormScreen()), GoRoute(path: ':id', builder: (_, state) => PurchaseOrderDetailScreen(id: state.pathParameters['id']!))]),
